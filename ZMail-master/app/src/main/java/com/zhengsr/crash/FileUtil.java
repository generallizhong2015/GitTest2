...
public class FileUtil {
    ...
    //读取指定目录下的所有TXT文件的文件内容/storage/emulated/0/crash/Ex_crash.txt
...
//        if (sdCardExist) {
            StorageDirectory = Environment.getExternalStorageDirectory() + File.separator + "Ex_crash.txt";
//        } else {
//            StorageDirectory = Environment.getDataDirectory() + File.separator + "crash" + File.separator + "Ex_crash.txt";
//        }
