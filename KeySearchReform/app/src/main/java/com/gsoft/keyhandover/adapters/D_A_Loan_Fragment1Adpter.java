...
public class D_A_Loan_Fragment1Adpter extends BaseAdapter {
    ...
    public D_A_Loan_Fragment1Adpter(Context context,
                                    List<Map<String, Object>> lists, int flag) {
        this.lists = lists;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (flag == 1) {
            holder.nJieChuRen_txt.setText(lists.get(i).get("GetName").toString());
            holder.nDengDingka_txt.setText(lists.get(i).get("Card").toString());
            holder.nAnQuandai_txt.setText(lists.get(i).get("Belt").toString());
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            holder.nTime_txt.setText(sdf.format(lists.get(i).get("GTime")));
        } else {
            holder.nJieChuRen_txt.setText(lists.get(i).get("GetName").toString());
            holder.nDengDingka_txt.setText(lists.get(i).get("Card").toString());
            holder.nAnQuandai_txt.setText(lists.get(i).get("Belt").toString());
