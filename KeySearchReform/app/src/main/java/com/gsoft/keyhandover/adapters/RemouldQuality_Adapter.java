...
public class RemouldQuality_Adapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vh.A_ht = convertView.findViewById(R.id.ht_txt);
        ...
        vh.A_ht.setText(ZhiJian_list.get(position).get("qaCompleteCount").toString() + "/" + ZhiJian_list.get(position).get("nodeTotal").toString());
        return convertView;
    }
