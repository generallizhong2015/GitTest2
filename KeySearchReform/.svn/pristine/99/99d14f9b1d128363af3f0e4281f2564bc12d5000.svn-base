...
public class KeyHandoverActivity extends FragmentActivity {
    // 定义FragmentTabHost对象
    private FragmentTabHost mTabHost;
    // 定义一个布局
    private LayoutInflater layoutInflater;
    private Class fragmentArray[] = {KeyFragment1.class, KeyFragment2.class};
    private int mImageViewArray[] = {R.drawable.tab_finding, R.drawable.tab_recording};
    private String mTextViewArray[] = {"钥匙交接", "钥匙查询"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.keytab);
        initView();
    }
